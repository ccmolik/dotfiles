(custom-set-variables
 ...
 '(package-selected-packages (quote (go-eldoc yaml-mode fiplr go-mode exec-path-from-shell rebecca-theme auto-complete rbenv web-mode go-autocomplete puppet-mode))))
(custom-set-faces
